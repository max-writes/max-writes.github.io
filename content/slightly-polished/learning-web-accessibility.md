---
title: My Approach to Learning Web Accessibility
draft: false
tags: learning
date: 2025-11-21
---
...
- "What barriers might I be missing?"
...
My advice:
- Familiarize yourself with where to find answers before you need them. Bookmark the support/docs site for the tools you already use.
- When you're making something new, review the 4 principles of accessibility and if any of them hit what you're doing, research what tools you can use to make the content accessible. Examples:
	- You identify you have a video to add to your website. Match it to "perceivable," search "how to make videos accessible on the web" to make sure you're doing it right and including the proper supplementary files.
	- You're figuring out the color palette for an image or stylesheet. Match it to "perceivable," search for "color accessibility checker" or "color contrast checker" to make sure you're using accessible color combinations.
- If a resource or tool doesn't exist, make your own (personal checklists, notes, or reference guides for your future self).
> [!example] Tools
	- Use sites like Fiverr to hire a human create transcripts or closed captions.
...
> [!example] Learn Web Accessibility
	- a11yphant: Web accessibility one step at a time, free of charge.
	- Pop Tech Blog: Monthly accessibility post (and email, if you subscribe) on various topics to enhance your learning over time.
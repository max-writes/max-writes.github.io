...
> 				Debate
> 				Documentation
> 				Premises: Defined starting assumptions
> 				Prerequisites: Software, permissions, context
> 				Thesis: A central claim or question
> 				User Goal: The task or outcome the user wants
> 				Dialectic Process: Explore every angle
> 				Review: Validate every workflow
> 				Antithesis: The counterargument
> 				Error Path: What happens when it doesn’t go as planned
> 				Synthesis: A new understanding that resolves both
> 				Resolution: A clear, tested path to success
...
> [!NOTE] Parallels, Extended Edition
